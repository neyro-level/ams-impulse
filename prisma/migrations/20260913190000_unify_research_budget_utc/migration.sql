CREATE OR REPLACE FUNCTION "platform"."research_budget_boundaries"(
  reference_time TIMESTAMPTZ
)
RETURNS TABLE ("dayStart" TIMESTAMPTZ, "monthStart" TIMESTAMPTZ)
LANGUAGE sql
IMMUTABLE
...
REVOKE ALL ON FUNCTION "platform"."research_budget_boundaries"(TIMESTAMPTZ) FROM PUBLIC;
REVOKE ALL ON FUNCTION "platform"."research_committed_spend"(TEXT, TEXT, TIMESTAMPTZ) FROM PUBLIC;

GRANT EXECUTE ON FUNCTION "platform"."research_budget_boundaries"(TIMESTAMPTZ) TO ams_web;
