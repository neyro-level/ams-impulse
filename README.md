...
- Аудитории, Разбор сайтов, АМС Лиды, Договоры, Счета, Презентации и Клон сайтов пока не реализованы.
...
Запланированные инструменты: Аудитории, Разбор сайтов, Договоры, Счета, Презентации, Клон сайтов.
...
- [`docs/modules/MODULE_AUDIENCE_INTELLIGENCE.md`](docs/modules/MODULE_AUDIENCE_INTELLIGENCE.md)
