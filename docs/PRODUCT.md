...
Публичная страница предлагает обсудить продвижение, а не самостоятельную регистрацию или безусловный тестовый период.

```text
Заявка с именем и телефоном
-> уточнение задачи и квалификация
-> согласование формата работы
-> создание учётной записи и доступа администратором, если услуга подходит
```
